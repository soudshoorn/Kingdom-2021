...
public class LunarClientLoginListener implements Listener {
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        Bukkit.getScheduler().runTaskLater(lunarClientAPI.getPlugin(), () -> {
    ...
    public void onRegister(PlayerRegisterChannelEvent event) {
        ...
        lunarClientAPI.getPlugin().getServer().getPluginManager().callEvent(new LCPlayerRegisterEvent(event.getPlayer()));
